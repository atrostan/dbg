...
template<class vertex>
void
generateRandomMapping(const graph<vertex> &GA, bool isSym, bool useOutdeg, pvector<uintE> &new_ids, bool isPageRank,
                      bool isDenseWrite) {
	Timer t;
	t.Start();
...
template<class vertex>
void
generateHubSortDBGMapping(const graph<vertex> &GA, bool isSym, bool useOutdeg, pvector<uintE> &new_ids, bool isPageRank,
                          bool isDenseWrite) {
	Timer t;
	t.Start();
...
template<class vertex>
void generateHubClusterDBGMapping(const graph<vertex> &GA, bool isSym, bool useOutdeg, pvector<uintE> &new_ids,
                                  bool isPageRank, bool isDenseWrite) {
	Timer t;
	t.Start();
...
template<class vertex>
void generateDBGMapping(const graph<vertex> &GA, bool isSym, bool useOutdeg, pvector<uintE> &new_ids, bool isPageRank,
                        bool isDenseWrite) {
	Timer t;
	t.Start();
...
template<class vertex>
void generateSortMapping(const graph<vertex> &GA, bool isSym, bool useOutdeg, pvector<uintE> &new_ids, bool isPageRank,
                         bool isDenseWrite) {
	Timer t;
	t.Start();
...
//2 1
template<class vertex>
void LoadMappingFromFile(const graph<vertex> &GA, bool isSym, bool useOutdeg, pvector<uintE> &new_ids, bool isPageRank,
                         bool isDenseWrite) {
	Timer t;
	t.Start();
...
void generateMapping(const graph<vertex> &GA, ReorderingAlgo reordering_algo, bool isSym, bool useOutdeg,
	...
	std::ofstream outfile(order_file);
